...
public class ProductsController : ControllerBase
{
    ...
    public ProductsController(SushiDbContext db) => _db = db;
    ...
    public async Task<ActionResult<Product>> Create([FromBody] ProductCreate dto)
    {
    ...
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    public async Task<IActionResult> Update(int id, [FromBody] ProductUpdate dto)
    {
        if (!ModelState.IsValid) return ValidationProblem(ModelState);
